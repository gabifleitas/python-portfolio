...
Original file is located at
    https://colab.research.google.com/drive/1s9ZrcFoGRrT06zDPTY23T_GSEPepVzBj
"""
...
insta_orders=pd.read_csv('/content/drive/My Drive/instacart_orders.csv',sep=';')
products=pd.read_csv('/content/drive/My Drive/products.csv',sep=';')
aisles=pd.read_csv('/content/drive/My Drive/aisles.csv',sep=';')
departments=pd.read_csv('/content/drive/My Drive/departments.csv',sep=';')
order_product=pd.read_csv('/content/drive/My Drive/order_products.csv',sep=';')
